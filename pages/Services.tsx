      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, idx) => (
                <div key={idx} className="bg-white p-10 hover:shadow-xl transition-shadow duration-300 group border border-gray-100" data-aos="fade-up" data-aos-delay={idx * 50}>
      ...
      <section className="py-24 bg-zenthera-light border-y border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
                  ...
                  <div className="hidden md:block absolute top-8 left-0 right-0 h-0.5 bg-gray-300 -z-10 transform translate-y-4" data-aos="fade-in" data-aos-delay="500"></div>

                  {processSteps.map((step, idx) => (
                      <div key={idx} className="bg-zenthera-light pt-0 md:pt-4 text-center" data-aos="fade-up" data-aos-delay={idx * 200}>
      ...
      <section className="py-24 bg-zenthera-dark text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div className="relative h-[500px] border border-gray-800" data-aos="fade-left">
      ...
      <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="relative group overflow-hidden h-80" data-aos="zoom-in" data-aos-delay="0">
                   ...
                   <div className="relative group overflow-hidden h-80" data-aos="zoom-in" data-aos-delay="100">
                   ...
                   <div className="relative group overflow-hidden h-80" data-aos="zoom-in" data-aos-delay="200">
